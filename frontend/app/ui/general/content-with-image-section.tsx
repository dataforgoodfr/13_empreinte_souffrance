...
export default function ContentWithImageSection({text_content, image_url, image_description, image_position = 'left', hide_image_on_small_screen = false}: ContentWithImageSectionProps) {
    return (
        <section
            className={clsx(
