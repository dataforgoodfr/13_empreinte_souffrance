...
export default function HeroSection() {
    return (
        <section
            className="bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-500 h-screen flex items-center justify-between px-8 sm:px-16">
            <div className="max-w-xl space-y-6">
                <div
                    className="inline-block bg-indigo-800 text-white py-2 px-4 rounded-lg text-sm font-semibold tracking-wide">
                    Embracing free-range for every chicken in Europe!
                </div>
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white">
                    Animal Welfare<br/>
                    <span className="text-green-300">Science</span><br/>
                    explained
                </h1>
