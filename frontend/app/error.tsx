  ...
  return (
    <section className="w-full bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-500 h-screen flex items-center justify-around px-8 sm:px-16">
      <div className="max-w-xl space-y-6 flex flex-col">
        <div className="inline-block bg-indigo-800 light-text py-2 px-4 rounded-lg text-sm font-semibold tracking-wide w-max">
          🐣🐥🐤🐔
        </div>
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold light-text">Something went wrong!</h1>
