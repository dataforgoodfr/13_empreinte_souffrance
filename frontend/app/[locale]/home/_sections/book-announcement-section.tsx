      ...
      <article className="max-w-xl lg:mr-16">
        <header>
          <h2
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-extrabold font-mono dark-text mb-8"
          >
            {t('BookAnnouncement.title')}
          </h2>
        </header>
        <main>
          <p className="dark-text text-base sm:text-lg mb-4">
          ...
          <p className="dark-text text-base sm:text-lg">{t('BookAnnouncement.description')}</p>
        </main>
      </article>
