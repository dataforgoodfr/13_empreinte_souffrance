...
export default function PressWithLogos() {
  return (
    <div className="mt-15 md:mt-10 px-5 md:px-20 xl:px-60">
      <div className="bg-violet py-5 rounded-md">
        <h4 className="font-mono ml-5">La presse en parle :</h4>
        <div className="flex flex-wrap justify-center gap-8 mt-4 mb-2">
          <div className="flex flex-col sm:flex-col md:flex-row gap-6 ">
            <div className="flex justify-center gap-6">
              <Link href="https://photos.app.goo.gl/jdmkpY5PHqsgYzPh9" target="_blank">
                <Image
              ...
              <Link href="https://photos.app.goo.gl/eJ5qrFGbo4FAtRoh6" target="_blank">
                <Image
            ...
            <div className="flex justify-center gap-6">
              <Link href="https://photos.app.goo.gl/5XFgLL4NRS5Jcrf67" target="_blank">
                <Image
                  src="/press-logos/M6.png"
                  width={120}
                  height={60}
                  alt="Logo M6"
                  className="object-contain h-10"
