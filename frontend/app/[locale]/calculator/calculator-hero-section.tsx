...
export default async function CalculatorHeroSection() {
  ...
  return (
    <section className="scroll-mt-18 max-w-screen p-8 sm:px-16 w-full bg-white flex flex-col items-center gap-16">
      ...
      <figure className = "flex flex-col sm:flex-row max-w-4/5 gap-6">
        <Image
          src="/eggs_box.jpeg"
          width={540}
          height={740}
        ...
        />
        <figcaption className="text-2xl sm:m-32 text-[#3b0a0a] ">{scopedT('descriptionSection.figcaption')}</figcaption>
      </figure>
    </section>
  );
}
