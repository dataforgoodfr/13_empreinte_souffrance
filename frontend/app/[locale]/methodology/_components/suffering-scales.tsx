...
export default function SufferingScales({
  ...
  return (
    <>
      ...
      <p className="flex justify-center items-center w-full p-1 text-center bg-pink-3">{suffering_duration_text}</p>
      <p className="flex justify-center items-center w-full p-1 text-center bg-pink-2">{pain_duration_text}</p>
