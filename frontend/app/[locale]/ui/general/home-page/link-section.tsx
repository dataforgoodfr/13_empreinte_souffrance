    ...
    <section className="w-full bg-white flex flex-wrap items-center justify-center">
      {links.map((link) => (
        <Link
          ...
          className="py-2 px-4 text-center font-mono tracking-widest dark-text border border-red-300 hover:bg-(--violet-1) text-nowrap min-w-35 md:min-w-100 lg:min-w-120 grow transition-all duration-200"
