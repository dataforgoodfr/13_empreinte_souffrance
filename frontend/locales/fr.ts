...
//
// For classic translations
// => Page > Section > Component > Elements
//
// For reusable components or sections:
...
export default {
  ...
  BookAnnouncement: {
    ...
    bookTitle:
      'The Welfare Footprint of the Egg : A Comprehensive Analysis of Animal Welfare Impacts of Egg Production',
    publisher: 'chez Taylor & Francis (CRC Press)',
    description:
      'Cet ouvrage pionnier présentera la première quantification de l’impact de la production d’un aliment sur les animaux d’élevage.',
  ...
  MethodologyPage: {
    ...
    sufferingQuantificationSteps: {
      ...
      step2: {
        ...
        bloc1: {
          ...
          agony: '0min d’agonie',
          pain: '37h 28min de douleur',
          suffering: '2h 39min de souffrance',
          discomfort: '30h 12min d’inconfort',
        },
        bloc2: {
    ...
    method_details_section: {
      ...
      description:
        "Une revue approfondie de la littérature scientifique a été menée afin d'identifier les principales sources de douleur chez les poules en production animale, ainsi que leur fréquence selon le mode d'élevage. Il peut s'agir de douleurs physiques (fractures, lésions cutanées, infections, etc.) ou psychologiques (peur, restriction des besoins comportementaux, etc.). Au total, xx sources de douleur ont été identifiées et étudiées par le Welfare Footprint Institute, à partir d'une étude de yy articles.",
